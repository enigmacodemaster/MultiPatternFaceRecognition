...
class Resnet18Triplet(nn.Module):
    ...
    def forward(self, images):
        ...
        by scalar (alpha)."""
        embedding = self.model(images) # 提出来的feature
...
def model_save(epoch):
	...
	torch.save(state, 'Model_training_checkpoints/model_{}_triplet_epoch_{}.pt'.format('resnet18', epoch + 1))
...
for epoch in range(start_epoch, end_epoch):
    ...
    for batch_idx, (batch_sample) in progress_bar:     
        ...
        triplet_loss = TripletLoss(margin=0.1).forward(
