...
class Resnet34Triplet(nn.Module):
    ...
    def __init__(self, embedding_dimension=128, pretrained=False):
        ...
        self.model = model
        #self.model = models.resnet18(pretrained = True) # 预训练好的resnet18模型
        #self.model.avgpool = nn.AdaptiveAvgPool2d((1,1)) # 解决尺寸不匹配的问题
    ...
    def forward(self, images, pos_img):
        ...
        return embedding, attention_loss

model = Resnet34Triplet(pretrained = False,embedding_dimension = 128) # 这俩参数在这儿没啥意义
